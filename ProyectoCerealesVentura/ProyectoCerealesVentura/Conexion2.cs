...
namespace ProyectoCerealesVentura
{
    class Conexion2
    {
        ...
        {
            bool set = conec.setData(string.Format("Insert into Tabla1 (Usuario,Contraseña,Correo,Telefono) values('{0}','{1}','{2}','{3}')", "Miguel", "Miguel123", "MiguelMarcos@hotmail.com", "12213634"));
