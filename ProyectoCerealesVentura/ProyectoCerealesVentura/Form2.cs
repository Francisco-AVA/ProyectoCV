...
namespace ProyectoCerealesVentura
{
    public partial class RegistroEmpleados : Form
    {
        ...
        private void btregis2_Click(object sender, EventArgs e)
        {
        ...
        private void btRegresar1_Click(object sender, EventArgs e)
        {
            Inicio FormRegister = new Inicio();
            FormRegister.Show();
            this.Hide();
        }
        ...
        private void txtcontra2_Keypress(object sender, KeyPressEventArgs e)
        {
           ...
           ingresar un punto*/
            else if ((e.KeyChar == '.') && (!txtcontra2.Text.Contains(".")))
            {
                e.Handled = false;
            }
        ...
        private void txtconfir_Keypress(object sender, KeyPressEventArgs e)
        {
            //condicion para solo números
            if (char.IsDigit(e.KeyChar))
            {
        ...
        private void txttel_Keypress(object sender, KeyPressEventArgs e)
        {
            ...
            /*verifica que pueda ingresar punto y también que solo pueda
           ingresar un punto*/
            else if ((e.KeyChar == '.') && (!txttel.Text.Contains(".")))
            {
                e.Handled = false;
            }
            //si no se cumple nada de lo anterior entonces que no lo deje pasar
